...
var JSORMBase = /** @class */ (function () {
    ...
    Object.defineProperty(JSORMBase, "jwtStorage", {
        get: function () {
    ...
    JSORMBase.initializeCredentialStorage = function () {
    ...
    JSORMBase.fetchOptions = function () {
        var options = {
            headers: (_a = {
                ...
                }, _a["Content-Type"] = "application/json", _a)
        };
        var jwt = this.getJWT();
        if (jwt) {
    ...
    JSORMBase.extraParams = function (clause) {
    ...
    Object.defineProperty(JSORMBase, "jwt", {
        get: function () { return this.getJWT(); },
        set: function (token) { this.setJWT(token); },
        enumerable: true,
        configurable: true
    });
